    ...
    <div class="clients-form">
        <form>
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <fg-input label="Credit Card" placeholder="4585554818138161865" :max="19"
                              v-model="creditCard"></fg-input>
                </div>
                <div class="col-md-5">
                    <fg-input label="Credit Limit" placeholder="896.15" type="number"
                              v-model="client.creditlimit"></fg-input>
                </div>
                <div class="col-md-5 col-md-offset-1">
                    <fg-select label="Person Type" placeholder="Select a person type" v-model="client.persontype"
                               :options="personTypes" @change="updatePersonTypeId"></fg-select>
                </div>
                <div class="col-md-12">
                    <div class="text-center">
                        <button class="btn btn-info btn-fill btn-wd" :class="{'disabled': isSavingClient}"
...
export default {
  ...
  data() {
    return {
      ...
      personTypes: [],
      client: this.onEditionMode
        ? Object.assign({}, this.$props.clientToUpdate, {
